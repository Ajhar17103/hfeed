  ...
  return (
    <>
		  ...
		  <Slider {...settings} className="mb-5"  >
          {
                   ...
                   product.category_id==5 &&  <ProductSlide key={product.id} img={product.thumbnail} offer_price={product.offer_price} price={product.price} product_name={product.product_name.en} id={product.id} />
                    ))
           }
